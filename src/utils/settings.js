export const DROPLET_FOLDER = "/exam" // <-- replace with your folder that your create on droplet. 
...
export const BASE_URL = "https://acmverden.dk/tomcat/Exam"  // <-- replace it with your droplet url so that you can use your database on your droplet instead of local database
